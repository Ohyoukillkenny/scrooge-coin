...
public class Transaction {
    ...
    /** here index is simply a integer from 0 to len(inputs)-1 */
    public void removeInput(int index) {
        inputs.remove(index);
    }
    /** here we traverse the inputs in transaction to find whether there is a match that equals ut*/
    ...
    public byte[] getRawDataToSign(int index) {
        ...
        ByteBuffer b = ByteBuffer.allocate(Integer.SIZE / 8); // 4 bits
        ...
        for (Output op : outputs) {
            ByteBuffer bo = ByteBuffer.allocate(Double.SIZE / 8); // 8 bits, 1 byte
    ...
    /** here the index is inputs' index*/
